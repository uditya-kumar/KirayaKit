-- RentTrack — initial schema for Lakebase Postgres on Neon (PostgreSQL 18)
--
...
-- table holds only what RentTrack adds on top.
-- ---------------------------------------------------------------------------
CREATE TABLE users (
...
-- signed-in user, `anonymous` otherwise. RentTrack has no public data, so
